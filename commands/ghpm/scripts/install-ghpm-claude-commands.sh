...
cp -f "$SOURCE_DIR/ghpm:qa-create.md"       "$ROOT/.claude/commands/ghpm:qa-create.md"
cp -f "$SOURCE_DIR/ghpm:qa-create-steps.md" "$ROOT/.claude/commands/ghpm:qa-create-steps.md"
cp -f "$SOURCE_DIR/ghpm:qa-execute.md"      "$ROOT/.claude/commands/ghpm:qa-execute.md"
